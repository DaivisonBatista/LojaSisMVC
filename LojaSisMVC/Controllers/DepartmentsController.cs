...
namespace LojaSisMVC.Controllers
{
    ...
    {
        private readonly LojaSisMVCContext _context;

        public DepartmentsController(LojaSisMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departments != null ? 
                          ...
                          Problem("Entity set 'LojaSisMVCContext.Departments'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LojaSisMVCContext.Departments'  is null.");
            }
            var departments = await _context.Departments.FindAsync(id);
            if (departments != null)
            {
